  ...
  render: function render() {
    ...
    if (this.props.showBoxMenu) {
      ...
      boxMenu = _react2['default'].createElement(
        'div',
        { className: 'tools' },
        _react2['default'].createElement(_materialUiLibIconButton2['default'], {
          iconStyle: iconStyle,
          style: style,
      ...
      _react2['default'].createElement(
        ...
        this.props.title ? _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            this.props.titleIcon ? _react2['default'].createElement(_materialUiLibFontIcon2['default'], { className: "icon " + this.props.titleIcon }) : '',
            this.props.title
          ),
          boxMenu,
          boxControls
